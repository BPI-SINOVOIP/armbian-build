...
狀態：已進入實作；兩板 Noble 根系統與加速配套離線預檢已完成，四份官方格式候選已完成建置，108 項回歸及實際封裝離線驗證通過；完成紀錄見 [實作紀錄](bananapi-f3-cm6-vendor-implementation-20260917.md)。依使用者最新指示，先交付他人實測，再建立 AI 自動驗證環境；不等待本機實物接線。
