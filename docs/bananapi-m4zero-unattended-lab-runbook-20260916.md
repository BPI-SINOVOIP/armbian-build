...
目前完成主機寫卡與離線驗證，等待卡片插回 0845。下一位操作者必須先讀取同目錄的狀態 JSON；尚未取得板上證據的項目不得標成完成。
...
- SD CID：`03534453523634478697bc8c07018401`。
...
"$PY" -B tools/bpi_sram_lab_uart.py update-slot \
  ...
  --cid 03534453523634478697bc8c07018401 --sectors 124735488 \
