...
| 群組 | 樣本 | 狀態 |
| --- | --- | --- |
| BPI-M4 Zero 已知批次 | `0438` | X2 G1 通過，冷啟動 `1/10`，短壓力通過 |
| BPI-M4 Zero 已知批次 | `1116` | X2 G1 通過，冷啟動 `1/10` |
| BPI-M4 Zero 三星 DDR 批次 | `S337`，板身序號待補 | X2 G1 通過，冷啟動 `1/10`，短壓力通過 |
| BPI-M4 Zero 三星 DDR 批次 | `S322`，板身序號待補 | X2 G1 通過，冷啟動 `1/10`，短壓力通過；無線周邊待修 |
