...
function post_family_tweaks_bsp__bananapir4_network_firmware() {
	...
	mt7988_source="${SRC}/packages/blobs/filogic/firmware/mediatek/mt7988"
	display_alert "MT7988 網路韌體來源" \
	...
	run_host_command_logged install -Dm0644 \
	  "${mt7988_source}/LICENCE.mediatek" \
