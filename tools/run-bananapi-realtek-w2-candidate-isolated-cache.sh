...
export CANDIDATE_BUILDER="${repo_dir}/tools/build-bananapi-realtek-w2-candidate.sh"
export CACHE_LOWER="/media/pi/SMCI/armbian/bpi-v26.2.1/cache"
export CACHE_OVERLAY_ROOT="${repo_dir}/.tmp/bananapi-realtek-w2-candidate-cache-overlay"
export CACHE_TARGET="${repo_dir}/cache"
export ALLOW_INTERNAL_W2_CANDIDATE=yes
